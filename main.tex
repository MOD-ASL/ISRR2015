...
We demonstrate our system using the SMORES modular robot \cite{Davey2012},  but could easily be adapted
to any other modular robot for which an SDF description is available. Each SMORES modules has four DoF
...
\begin{figure}[tb]
  ...
  \caption{SMORES robot \TODO{Could this be combined with figure 1?  Use it
