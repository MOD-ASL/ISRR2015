...
during execution, and the maximum duration for which the configuration is not
gravitationally stable during execution is less than a time bound $t_{max}$.
Additionally, the configuration must be stable at the end of execution.
\end{definition}
...
\begin{figure}
\begin{center}
    \includegraphics[height=1.1in]{images/conf_window.png}
...
\caption{The design flow \TODO{Can this flowchart be made horizontal?}}
\label{fig:design}
\end{center}
\end{figure}
