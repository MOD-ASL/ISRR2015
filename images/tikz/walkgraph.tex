...
\node [process, below of = s4, yshift=0.75cm] (s7) {7 \\ left\_front\_leg \\ normal.gait};
\node [process, below of = s7, yshift=1.5cm] (s8) {8 \\ right\_back\_leg \\ normal.gait};

\node [process, below of = s3, yshift=-1.25cm] (s9) {9};
...
\node [process, below of = s0, yshift=-1.25cm] (s12) {12};

\node [startstop, below of = start, yshift=-1.25cm] (end) {End};
